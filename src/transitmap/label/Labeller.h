...
class Labeller {
 public:
  ...
  void label(const shared::rendergraph::RenderGraph& g, bool notdeg2, std::unordered_map<std::string, std::pair<std::string, std::string>>& simplerLabels);
 ...
 private:
  ...
  void labelLines(const shared::rendergraph::RenderGraph& g, std::unordered_map<std::string, std::pair<std::string, std::string>>& simplerLabels);
